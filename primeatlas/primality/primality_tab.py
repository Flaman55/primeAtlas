...
Backend logic (primeatlas.primality.primality: run_all_tests/factorize/try_import_sympy) was
...
class PrimalityTab(BaseTab):
    ...
    def _primality_job(self, job, report_progress):
        ...
        ever in flight). No WSL subprocess here at all -- primeatlas.primality.primality is
