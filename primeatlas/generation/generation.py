...
# UI split (primeatlas/primes/primes_tab.py) -- see that module's own docstring for why this whole
...
# primeatlas/benchmark/benchmark.py, alongside the rest of the Benchmark tab's pure logic -- see that
...
# primeatlas/research/research_goldbach.py, alongside the Goldbach sub-tab's own UI split (see
# primeatlas/research/research_goldbach_tab.py's own docstring) -- neither is used by anything
# else in this file.
...
# save_totals_cache/update_floor_totals_cache live in primeatlas/core/storage.py -- see that
...
# find_constellation_participation live in primeatlas/constellations/constellations.py, alongside the
# Constellations tab's own UI split (primeatlas/constellations/constellations_hits_tab.py,
# primeatlas/constellations/constellations_calc_tab.py, primeatlas/constellations/constellations_records_tab.py) --
